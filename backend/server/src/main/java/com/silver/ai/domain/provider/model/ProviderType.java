...
public enum ProviderType {
    ...
    ZHIPUAI("智谱AI", "https://open.bigmodel.cn/api/paas", true, Set.of(Capability.CHAT, Capability.EMBEDDING)),
    DEEPSEEK("DeepSeek", "https://api.deepseek.com", true, Set.of(Capability.CHAT)),
    DASHSCOPE("通义千问", "https://dashscope.aliyuncs.com/compatible-mode", true, Set.of(Capability.CHAT, Capability.EMBEDDING)),
    QIANFAN("文心一言", "https://qianfan.baidubce.com", true, Set.of(Capability.CHAT, Capability.EMBEDDING)),
    MOONSHOT("月之暗面", "https://api.moonshot.cn", true, Set.of(Capability.CHAT));
