...
public class KnowledgeBaseRepositoryAdapter implements KnowledgeBaseRepository {
    ...
    private KnowledgeBaseEntity toEntity(KnowledgeBase d) {
        return KnowledgeBaseEntity.builder()
                ...
                .semanticThreshold(d.getChunkStrategy().getSemanticThreshold())
                .childChunkSize(d.getChunkStrategy().getChildChunkSize())
                .windowSize(d.getChunkStrategy().getWindowSize())
                .enableParentChild(d.getChunkStrategy().isEnableParentChild())
                ...
                .retrievalMode(d.getRetrievalConfig().getRetrievalMode())
                .keywordWeight(d.getRetrievalConfig().getKeywordWeight())
                .vectorWeight(d.getRetrievalConfig().getVectorWeight())
                .rerankerEnabled(d.getRetrievalConfig().isRerankerEnabled())
                .rerankerTopK(d.getRetrievalConfig().getRerankerTopK())
    ...
    private KnowledgeBase toDomain(KnowledgeBaseEntity e) {
        return KnowledgeBase.builder()
                ...
                .chunkStrategy(ChunkStrategy.builder()
                    ...
                    .semanticThreshold(e.getSemanticThreshold())
                    .childChunkSize(e.getChildChunkSize())
                    .windowSize(e.getWindowSize())
                    .enableParentChild(e.isEnableParentChild())
                        .build())
                .retrievalConfig(RetrievalConfig.builder()
                        ...
                        .retrievalMode(e.getRetrievalMode())
                        .keywordWeight(e.getKeywordWeight())
                        .vectorWeight(e.getVectorWeight())
                    .rerankerEnabled(e.isRerankerEnabled())
                    .rerankerTopK(e.getRerankerTopK())
                    .windowSize(e.getWindowSize())
                        .build())
